...
BOOL MyStartupDlg::OnInitDialog()
{
	...
	m_List_Startup.InsertColumn(1, TEXT("程序位置"), 0, 480);
	m_List_Startup.InsertColumn(2, TEXT("注册表位置"), 0, 340);
...
void MyStartupDlg::PrintStartup()
{
	...
	TCHAR *REG_RUN[3] = { L"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run",
		L"SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Run" ,L"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run"};
	HKEY HKEY_RUN[3] = { HKEY_CURRENT_USER ,HKEY_LOCAL_MACHINE ,HKEY_LOCAL_MACHINE };
