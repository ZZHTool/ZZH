...
BOOL MyServiceDlg::OnInitDialog()
{
	...
	m_List_Service.InsertColumn(0, TEXT("服务名称"), 0, 300);
	m_List_Service.InsertColumn(1, TEXT("显示名称"), 0, 300);
	m_List_Service.InsertColumn(2, TEXT("状态"), 0, 70);
	m_List_Service.InsertColumn(3, TEXT("类别"), 0, 50);
	m_List_Service.InsertColumn(4, TEXT("程序路径"), 0, 350);
