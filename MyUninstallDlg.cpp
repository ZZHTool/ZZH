...
BOOL MyUnistallDlg::OnInitDialog()
{
	...
	m_List_Unistall.InsertColumn(0, TEXT("软件名称"), 0, 450);
	m_List_Unistall.InsertColumn(1, TEXT("出品公司"), 0, 230);
	m_List_Unistall.InsertColumn(2, TEXT("版本"), 0, 100);
	m_List_Unistall.InsertColumn(3, TEXT("卸载目录"), 0, 300);
